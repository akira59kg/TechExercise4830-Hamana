...
public class InsertHamana extends HttpServlet {
   ...
   protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
      ...
      String insertSql = " INSERT INTO MyTableHamanaT3 (id, FIRST_NAME, LAST_NAME, PHONE, DATE, TIME) values (default, ?, ?, ?, ?, ?)";
      ...
      out.println("<a href=/TechExercise4830Hamana/search_hamana.html>Search Data</a> <br>");
