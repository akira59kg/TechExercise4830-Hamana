...
public class UtilPropHamana{
   ...
   static String _PROP_FILENAME_OSX_LOCAL = "/Users/akira59lift/eclipse-workspace/workspace4830-0915-Hamana/TechExercise4830Hamana/WebContent/config.properties";
   // * Remote server path
   static String _PROP_FILENAME_REMOTE = "/var/lib/tomcat7/webapps/TechExercise4830Hamana/config.properties";
